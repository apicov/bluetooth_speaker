...
volatile uint32_t s_tx_lane_fail[TX_LANE_N];
volatile int64_t  s_tx_frame_sent_us;
volatile uint32_t n_refuse_near_frame;
volatile uint32_t n_audio_retry;
volatile uint32_t n_audio_retry_ok;
volatile uint32_t n_join_churn;
...
volatile uint32_t n_fec_sent;
volatile uint32_t n_fec_skipped;
volatile uint32_t n_fec_cong_skip;
